...
def create_synthesize_response_task(supervisor: Agent) -> Task:
    return Task(
        description=(
            ...
            "Number the cases you cite sequentially (Case 1, Case 2, …) regardless of their original ISSUE # from the tool output.\n"
            ...
            "- When CROSS_FLEET_FALLBACK: false and rows are present, the vehicle IS in the fleet KB. "
            "Label rows as 'KB case'. Do NOT write 'not in our fleet KB' or 'cross-fleet'.\n"
